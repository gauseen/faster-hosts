...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".header {\n  width: 100%;\n  height: 40px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 0 10px;\n  background-color: aliceblue;\n}\n\n.header_add {\n  width: 18px;\n  height: 18px;\n}\n", "",{"version":3,"sources":["webpack://src/popup/components/Header/style.css"],"names":[],"mappings":"AAAA;EACE,WAAW;EACX,YAAY;EACZ,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;EACnB,eAAe;EACf,2BAA2B;AAC7B;;AAEA;EACE,WAAW;EACX,YAAY;AACd","sourcesContent":[".header {\n  width: 100%;\n  height: 40px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 0 10px;\n  background-color: aliceblue;\n}\n\n.header_add {\n  width: 18px;\n  height: 18px;\n}\n"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=main.8b3af23325e61aab9dbc.hot-update.js.map